...
public class RubinsArmorItem extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:rubins_armor_helmet")
	public static final Item helmet = null;
	@ObjectHolder("funnyideas1:rubins_armor_chestplate")
	public static final Item body = null;
	@ObjectHolder("funnyideas1:rubins_armor_leggings")
	public static final Item legs = null;
	@ObjectHolder("funnyideas1:rubins_armor_boots")
	public static final Item boots = null;
	public RubinsArmorItem(Funnyideas1ModElements instance) {
		super(instance, 82);
	}
	...
	public void initElements() {
		IArmorMaterial armormaterial = new IArmorMaterial() {
			...
			public Ingredient getRepairMaterial() {
				return Ingredient.fromStacks(new ItemStack(RubinItem.block, (int) (1)));
			}
		...
		elements.items.add(() -> new ArmorItem(armormaterial, EquipmentSlotType.HEAD, new Item.Properties().group(UFOSIdeasTabItemGroup.tab)) {
			...
			public String getArmorTexture(ItemStack stack, Entity entity, EquipmentSlotType slot, String type) {
				return "funnyideas1:textures/models/armor/rubins_layer_" + (slot == EquipmentSlotType.LEGS ? "2" : "1") + ".png";
			}
		}.setRegistryName("rubins_armor_helmet"));
		...
		}.setRegistryName("rubins_armor_chestplate"));
		...
		}.setRegistryName("rubins_armor_leggings"));
		...
		}.setRegistryName("rubins_armor_boots"));
	}
}
