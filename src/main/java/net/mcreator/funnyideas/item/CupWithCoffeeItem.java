...
public class CupWithCoffeeItem extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:cup_with_coffee")
	public static final Item block = null;
	public CupWithCoffeeItem(Funnyideas1ModElements instance) {
		super(instance, 26);
	}
