...
import net.mcreator.funnyideas.gui.PassportGuiGui;
...
public class PassportItem extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:passport")
	public static final Item block = null;
	public PassportItem(Funnyideas1ModElements instance) {
		super(instance, 134);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof PassportGuiGui.GuiWindow) {
	...
	public static class ItemCustom extends Item {
		public ItemCustom() {
			super(new Item.Properties().group(UFOSIdeasTabItemGroup.tab).maxStackSize(1).rarity(Rarity.UNCOMMON));
			setRegistryName("passport");
		}
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public ITextComponent getDisplayName() {
						return new StringTextComponent("Passport");
					}
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new PassportGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
