...
public class RubinShovelItem extends FunnyideasModElements.ModElement {
	@ObjectHolder("funnyideas:rubin_shovel")
	public static final Item block = null;
	public RubinShovelItem(FunnyideasModElements instance) {
		super(instance, 50);
	}
