...
import net.mcreator.funnyideas.gui.CacheGuiGui;
...
public class CacheItemItem extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:cache_item")
	public static final Item block = null;
	public CacheItemItem(Funnyideas1ModElements instance) {
		super(instance, 68);
	...
	public void onItemDropped(ItemTossEvent event) {
		if (event.getEntityItem().getItem().getItem() == block) {
			if (Minecraft.getInstance().currentScreen instanceof CacheGuiGui.GuiWindow) {
			...
			if (entity instanceof ServerPlayerEntity) {
				NetworkHooks.openGui((ServerPlayerEntity) entity, new INamedContainerProvider() {
					...
					public Container createMenu(int id, PlayerInventory inventory, PlayerEntity player) {
						...
						return new CacheGuiGui.GuiContainerMod(id, inventory, packetBuffer);
					}
				}, buf -> {
