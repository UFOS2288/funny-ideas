...
public class SoySauseItem extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:soy_sause")
	public static final Item block = null;
	public SoySauseItem(Funnyideas1ModElements instance) {
		super(instance, 6);
	}
