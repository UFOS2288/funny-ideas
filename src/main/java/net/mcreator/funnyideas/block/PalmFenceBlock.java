...
public class PalmFenceBlock extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:palm_fence")
	public static final Block block = null;
	public PalmFenceBlock(Funnyideas1ModElements instance) {
		super(instance, 142);
	}
