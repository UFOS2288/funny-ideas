...
import net.mcreator.funnyideas.item.SaltDustItem;
...
public class SaltOreBlock extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:salt_ore")
	public static final Block block = null;
	public SaltOreBlock(Funnyideas1ModElements instance) {
		super(instance, 156);
	}
	...
	public static class CustomBlock extends Block {
		...
		public List<ItemStack> getDrops(BlockState state, LootContext.Builder builder) {
			...
			return Collections.singletonList(new ItemStack(SaltDustItem.block, (int) (3)));
		}
	}
	@Override
