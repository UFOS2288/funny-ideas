...
public class SaltBlockBlock extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:salt_block")
	public static final Block block = null;
	public SaltBlockBlock(Funnyideas1ModElements instance) {
		super(instance, 157);
	}
