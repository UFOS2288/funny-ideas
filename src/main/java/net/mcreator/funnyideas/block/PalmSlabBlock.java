...
public class PalmSlabBlock extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:palm_slab")
	public static final Block block = null;
	public PalmSlabBlock(Funnyideas1ModElements instance) {
		super(instance, 141);
	}
