...
public class PalmLogBlock extends Funnyideas1ModElements.ModElement {
	@ObjectHolder("funnyideas1:palm_log")
	public static final Block block = null;
	public PalmLogBlock(Funnyideas1ModElements instance) {
		super(instance, 137);
	}
